            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('admin.quizzes.store') }}" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="question_number" class="form-control-label">{{ __('Questions Number') }}</label>
                                <div class="@error('quiz.question_number')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number"
                                           placeholder="Enter The Number of Questions" id="question_number" name="question_number">
