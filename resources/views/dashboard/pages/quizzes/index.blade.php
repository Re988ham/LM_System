                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <a href="{{ route('admin.quizzes.create', $courseId) }}" class="btn bg-gradient-primary btn-sm mb-0"
                               type="button">
                                +&nbsp; New Quiz
                            </a>
                        </div>
                            ...
                            <table id="myDataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach ($quizzes as $quiz)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.quiz.questions', $quiz->id) }}" class="mx-3"
                                               data-bs-toggle="tooltip"
                                               data-bs-original-title="Show Quiz Questions">
                                                <i class="fas fa-question text-secondary" aria-hidden="true"></i>
                                            </a>
                                            <a href="{{ route('admin.quizzes.edit', $quiz->id) }}" class="mx-3"
                                               data-bs-toggle="tooltip" data-bs-original-title="Edit Quiz">
                                                <i class="fas fa-edit text-secondary"></i>
                                            </a>
                                            <a href="{{ route('admin.quizzes.destroy', $quiz->id) }}"
                                               class="mx-3" data-bs-toggle="tooltip"
                                               data-bs-original-title="Delete Quiz">
