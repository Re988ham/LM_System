                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <a href="{{ route('admin.advertisements.create') }}" class="btn bg-gradient-primary btn-sm mb-0"
                               type="button">
                                +&nbsp; New Advertisement
                            </a>
                        </div>
                            ...
                            <table id="myDataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach ($ads as $advertisement)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.advertisements.edit', $advertisement->id) }}" class="mx-3"
                                               data-bs-toggle="tooltip" data-bs-original-title="Edit Advertisement">
                                                <i class="fas fa-edit text-secondary"></i>
                                            </a>
                                            <a href="{{ route('admin.advertisements.destroy', $advertisement->id) }}"
                                               class="mx-3" data-bs-toggle="tooltip"
                                               data-bs-original-title="Delete Advertisement">
