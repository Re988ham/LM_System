                  ...
                  <p class="mb-0">OR Sign in with these credentials:</p> --}}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row px-xl-5 px-sm-4 px-3">
                                        ...
                                        <div class="col-3 me-auto px-1">
                                            <a class="btn btn-outline-light w-100" href="{{url('/login/google')}}">
                                                <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <g id="Artboard" stroke="none" stroke-width="1" fill="none"
                                                       fill-rule="evenodd">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    ...
                                    <p class="mb-4 text-sm mx-auto">
                                        ...
                                        <a href="{{ route('signUp') }}"class="text-info text-gradient font-weight-bold">Sign
                                            up</a>
                                    </p>
                                </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                    <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/1_cleanup.jpg')"></div>
                                </div>
                            </div>
                        </div>
                    </div>
